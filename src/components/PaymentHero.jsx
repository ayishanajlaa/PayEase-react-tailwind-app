import { discount, pay } from "../assets";
      ...
      <div className="flex flex-col gap-5 flex-1 pr-10 md:pr-0">
        <div className="flex items-center gap-2 font-poppins bg-discount-gradient py-2 px-3 xs:px-5 text-lg rounded-xl w-[100%] xs:w-fit">
          ...
          <p className="sm:text-base text-xs">
            Get <span className="text-[#5A595E] font-[500]">20% Cashback</span>{" "}
            on Your First{" "}
            <span className="text-[#5A595E] font-[500]">Payment</span>
        ...
        <p className="text-base sm:text-lg md:text-xl text-dimWhite sm:mt-5 md:max-w-[470px]">
          Our team of experts uses a methodology to identify the most suitable
          payment methods for your needs. We analyze transaction security,
          convenience, and rewards.
        </p>
      </div>

      <div className="flex-1 relative flex items-center justify-center">
        <img src={pay} alt="robot" className="md:w-full md:h-full" />
